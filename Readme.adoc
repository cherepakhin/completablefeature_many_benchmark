...
|Кол-во выделяемых сервисом тредов меньше нагрузки (нагрузка 500 rps, а тредов выделено 100) . CompletableFeature в executorService = Executors.newFixedThreadPool(100) |>10 000 >|188 >|200-350
|===
