...
|===
|Схема|Среднее время ответа (мс) |К-во тредов (шт) |Память (Мб)
|Без CompletableFeature |5 000 >|229 >|150
|С CompletableFeature в executorService = Executors.newCachedThreadPool();. |1 000 >|847 >|~230
|Кол-во свободных тредов меньше нагрузки (нагрузка 500 rps, а тредов выделено 100) . CompletableFeature в executorService = Executors.newFixedThreadPool(100) |>10 000 >|188 >|200-350
|===
